...
services = {}
service_names = {}
for row in readrows("data/services.csv"):
    services[row.name] = {
...
teams = []
team_names = {}
for row in readrows("data/teams.csv"):
...
flagcnt = 0
for row in readrows("data/checker_results.csv"):
...
for row in readrows("data/submitted_flags.csv"):
